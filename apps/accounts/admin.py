...
from apps.accounts.models import WorkerProfile, WorkerSkill
...
class CustomUserAdmin(UserAdmin):
    ...
    fieldsets = (
        ('Akkaunt', {'fields': ('email', 'password')}),
        ('Shaxsiy ma`lumotlar', {'fields': ('full_name', 'phone_number', 'profile_photo', 'user_type')}),
